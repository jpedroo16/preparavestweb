  ...
  return (
    <View style={estilo.accordionContainer}>
      <TouchableOpacity 
        ...
        style={estilo.accordionHeader(expanded)}
      >
        <Text style={estilo.accordionTitle}>{title}</Text>
        <Text style={estilo.arrow(expanded)}>▶</Text> {/* Adicionando uma seta */}
      </TouchableOpacity>
...
export default function Conteudorel() {
  ...
  return (
    <ScrollView>
      <View>
        <Cabecalho />
         <Text style={estilo.texto}>Conteúdo Relevante</Text>
      ...
      <View style={{flexDirection: 'collumn'}}>
          ...
          <View style={estilo.container}>
            ...
            <View style={estilo.professores}> 
              ...
              <View >
                ...
                <Pressable onPress={() => window.open('https://www.youtube.com/@professorferretto', 'Vestibular')}>
                  <Text style={estilo.textoss}>Canal Youtube <Icon name="arrow-back" size={10} color="#555" style={{ marginLeft: 5 }} />
</Text>
            ...
            <View style={estilo.professores}>
              ...
              <View>
                ...
                <Pressable onPress={() => window.open('https://www.youtube.com/@sandrocuriodicasdemat/featured', 'Vestibular')}>
                  <Text style={estilo.textoss}>Canal Youtube <Icon name="arrow-back" size={10} color="#555" style={{ marginLeft: 5 }} /></Text>
            ...
            <View style={estilo.professores}>
              <Image
              style={estilo.Perfil}
              source={require('../../assets/Professores/unnamed.jpg')}
              />
              <View>
                <Text style={estilo.textosMaterias}>FisicaInterativa.Com</Text>
                <Pressable onPress={() => window.open('https://www.youtube.com/@fisicainterativa', 'Vestibular')}>
                  <Text style={estilo.textoss}>Canal Youtube <Icon name="arrow-back" size={10} color="#555" style={{ marginLeft: 5 }} /></Text>
                  <Text style={estilo.biografia}>Aulas de física ao vivo pelo Youtube para o ENEM e Vestibular. Sem complicação, basta se inscrever no canal, conectar e assistir</Text>
                </Pressable>
              </View>
            </View>
          </View> 
            ...
            <View style={estilo.professores}>
              <Image
              style={estilo.Perfil}
              source={require('../../assets/Professores/profsilvio.jpg')}
              />
              <View>
                <Text style={estilo.textosMaterias}>Prof. Silvio Predis - Química Nota 10</Text>
                <Pressable onPress={() => window.open('https://www.youtube.com/@ProfSilvioPredis', 'Vestibular')}>
                  <Text style={estilo.textoss}>Canal Youtube <Icon name="arrow-back" size={10} color="#555" style={{ marginLeft: 5 }} /></Text>
                  <Text style={estilo.biografia}>Se você tem o hábito de navegar pelas redes sociais, é bastante provável que já tenha ouvido falar no professor Silvio Predis. Graduado em química pela Universidade Federal do Rio de Janeiro (UFRJ), o professor costuma aparecer em vídeos viralizados na internet.</Text>
                </Pressable>
              </View>
            </View>
            </View>
            ...
            <View style={estilo.professores}>
              <Image
              style={estilo.Perfil}
              source={require('../../assets/Professores/pam.jpg')}
              />
              <View>
                <Text style={estilo.textosMaterias}>PAM GONÇALVES</Text>
                <Pressable onPress={() => window.open('https://www.youtube.com/@apamgoncalves', 'Vestibular')}>
                  <Text style={estilo.textoss}>Canal Youtube <Icon name="arrow-back" size={10} color="#555" style={{ marginLeft: 5 }} /></Text>
                  <Text style={estilo.biografia}>Desde 2009 falando de livros na internet | resenhas de livros, listas e discussões. </Text>
                </Pressable>
              </View>
            </View>
            <View style={estilo.professores}>
              <Image
              style={estilo.Perfil}
              source={require('../../assets/Professores/tati.jpg')}
              />
              <View>
                <Text style={estilo.textosMaterias}>tatianagfeltrin</Text>
                <Pressable onPress={() => window.open('https://www.youtube.com/@tatifeltrin', 'Vestibular')}>
                  <Text style={estilo.textoss}>Canal Youtube <Icon name="arrow-back" size={10} color="#555" style={{ marginLeft: 5 }} /></Text>
                  <Text style={estilo.biografia}>TLT - Ligando livros às pessoas </Text>
                </Pressable>
              </View>
            </View>
            </View>
            ...
            <View style={estilo.professores}>
              <Image
              style={estilo.Perfil}
              source={require('../../assets/Professores/profpaulo.jpg')}
              />
              <View>
                <Text style={estilo.textosMaterias}>Paulo Jubilut</Text>
                <Pressable onPress={() => window.open('https://www.youtube.com/@paulojubilut', 'Vestibular')}>
                  <Text style={estilo.textoss}>Canal Youtube <Icon name="arrow-back" size={10} color="#555" style={{ marginLeft: 5 }} /></Text>
                  <Text style={estilo.biografia}> Aqui eu me dedico a mostrar a ciência da vida de forma criativa e divertida, pra que você veja que a biologia vai muito além dos nomezinhos complicados da escola. Aqui você vai ver como a Biologia é um tesão! </Text>
                </Pressable>
              </View>
            </View>
            </View>
            ...
            <View style={estilo.professores}>
              <Image
              style={estilo.Perfil}
              source={require('../../assets/Professores/proffabricio.jpg')}
              />
              <View>
                <Text style={estilo.textosMaterias}>Fabrício Dutra</Text>
                <Pressable onPress={() => window.open('https://www.youtube.com/channel/UCqgCusJOneAeVOlT4TMZNiA', 'Vestibular')}>
                  <Text style={estilo.textoss}>Canal Youtube <Icon name="arrow-back" size={10} color="#555" style={{ marginLeft: 5 }} /></Text>
                  <Text style={estilo.biografia}>Carioca, botafoguense, Prof. de Português, formado em Letras - Português e Alemão - pela Universidade Federal do Rio de Janeiro. Especialista em concursos públicos. </Text>
                </Pressable>
              </View>
            </View>
            </View>
            ...
            <View style={estilo.professores}>
              <Image
              style={estilo.Perfil}
              source={require('../../assets/Professores/geobrasil.jpg')}
              />
              <View>
                <Text style={estilo.textosMaterias}>Geobrasil</Text>
                <Pressable onPress={() => window.open('https://www.youtube.com/@Geobrasil', 'Vestibular')}>
                  <Text style={estilo.textoss}>Canal Youtube <Icon name="arrow-back" size={10} color="#555" style={{ marginLeft: 5 }} /></Text>
                  <Text style={estilo.biografia}> Em nosso canal você vai encontrar conteúdos que vão além da Geografia, pois acreditamos em uma Educação Integral, sendo assim iremos contemplar também diversos conteúdos pautado no Desenvolvimento Humano. </Text>
                </Pressable>
              </View>
            </View>
            ...
            <View style={estilo.professores}>
              <Image
              style={estilo.Perfil}
              source={require('../../assets/Professores/profjean.jpg')}
              />
              <View>
                <Text style={estilo.textosMaterias}>Prof. JeanGrafia | GabaritaGeo | </Text>
                <Pressable onPress={() => window.open('https://www.youtube.com/@gabaritageo', 'Vestibular')}>
                  <Text style={estilo.textoss}>Canal Youtube <Icon name="arrow-back" size={10} color="#555" style={{ marginLeft: 5 }} /></Text>
                  <Text style={estilo.biografia}>O Prof. JeanGrafia é formado em Geografia pela UNESP em São Paulo, tem ampla experiência em Geografia e Geopolítica e é a maior autoridade em Vestibulares de São Paulo da Internet. </Text>
                </Pressable>
              </View>
            </View>
            </View>
            ...
            <View style={estilo.professores}>
              <Image
              style={estilo.Perfil}
              source={require('../../assets/Professores/canalprojeto.jpg')}
              />
              <View>
                <Text style={estilo.textosMaterias}>Canal ProjetoX</Text>
                <Pressable onPress={() => window.open('https://www.youtube.com/@CanalProjetoX', 'Vestibular')}>
                  <Text style={estilo.textoss}>Canal Youtube <Icon name="arrow-back" size={10} color="#555" style={{ marginLeft: 5 }} /></Text>
                  <Text style={estilo.biografia}>Só temos um sonho: te aprovar na UERJ, plataforma de videoaulas. </Text>
                </Pressable>
              </View>
            </View>
            </View>
