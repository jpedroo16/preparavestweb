...
import { profileStyles } from './style'; // Garanta que os estilos sejam corretos
...
const AvatarSelection = () => {
  ...
  const navigation = useNavigation(); // Acesse o objeto de navegação
  ...
  return (
    <View style={profileStyles.container}>
      ...
      <FlatList
        data={avatarImages}
        numColumns={3} // Exibir em 3 colunas
